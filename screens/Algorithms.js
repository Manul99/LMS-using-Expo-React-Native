...
import { StyleSheet, Text, View, TouchableHighlight, DrawerLayoutAndroid , Image, TouchableOpacity, ImageBackground,Alert, TouchableWithoutFeedback,ScrollView, } from 'react-native';
...
function Algorithms(props) {
    ...
    return (
     ...
     <View style={styles.body}>
        <Text style={{fontSize:30,color:'#fff'}}>Algorithms</Text>
        ...
        <View style={styles.section1}>
           ...
           < TouchableWithoutFeedback  onPress={toggleDropdown}>
            ...
            <Text style={{top:-20,left:20,fontSize:15}}>Exams</Text>
            <Text style={{top:1,left:20,fontSize:15}}>Assignments</Text>
            <Text style={{top:25,left:20,fontSize:15}}>Marks</Text>
           </View>
        </View>
